...
import PrintFloorPlan from '../printComponent/PrintFloorPlan';
...
export default function GIInputFormContainer(params) { // alert("GIInputFormContainer "+params.DsrID);
    ...
    React.useEffect(() => {
        ...
        }).then(function (response) { // alert('test1--> '+response.data.mGenInfoReport.OwnerName)
            ...
            <Container fixed>
                <Typography component="div"
                            ...
                            <div class="upadate-gi-row">
                                <div class="upadate-gi-col-1">
                                    <FormControl className={
                                        ...
                                        <TextField required id="ownerName" label="Owner Name" variant="outlined"
                                            value={ownerName}
                                            size="small"
                                            style={
                                                {
                            ...
                            <div class="upadate-gi-row">
                                <div class="upadate-gi-col-1">
                                    <FormControl className={
                                        ...
                                        <TextField id="referenceNumber" label="Reference (VPC/UKP Number)" variant="outlined" size="small"
                                ...
                                <div class="upadate-gi-col-2">
                                    <FormControl className={
                                        ...
                                        <TextField id="structureCode" label="Structure Code" variant="outlined" size="small"
                                            value={structureCode}
                                            InputProps={
                                                {readOnly: true}
                                            }
                                ...
                                <div class="upadate-gi-col-3">
                                    <FormControl className={
                                        ...
                                        <TextField id="dsr" label="DSR Label" variant="outlined" size="small"
                                            value={dsr}
                                            InputProps={
                                                {readOnly: true}
                                            }
                    ...
                    <div class="row-small-bottom-grid1">
                        <GIAdditionalInfoTabs generalInfoID={generalInfoID}
                            dsrID={dsrid}/>
                    </div>
                    <div>
                        <Dialog fullScreen
                            ...
                            <AppBar className={
                                ...
                                <Toolbar>
                                    ...
                                    <Typography variant="h6"
                                        ...
                                        Floor Plan For - {ownerName} </Typography>
                                </Toolbar>
                            </AppBar>
                            <div>
                                {/* <FloorPlan generalInfoID={generalInfoID}
                                    structureCode={structureCode}
                                    ownerName={ownerName}/> */}
                                    <PrintFloorPlan generalInfoID={generalInfoID} structureCode={structureCode}
                                    ownerName={ownerName} />
                            </div>
                        </Dialog>
                    </div>
                            ...
                            <AppBar className={
                                ...
                                <Toolbar>
                                    ...
                                    <Typography variant="h6"
                                        ...
                                        General Information Report For - {ownerName} </Typography>
                                </Toolbar>
                            </AppBar>
                            <div>
                                <PrintableReportGeneralInfo generalInfoId={
                                    params.value
                                }/>
                            </div>
                        </Dialog>
                    ...
                    <div>
                        <Dialog fullScreen
                            open={openReportFieldMeasurements}
                            onClose={handleClose}
                            TransitionComponent={Transition}>
                            <AppBar className={
                                classes.appBar
                                ...
                                <Toolbar>
                                    ...
                                    <Typography variant="h6"
                                        ...
                                        Field Measurements For - {ownerName} </Typography>
                                </Toolbar>
                            </AppBar>
                            <div>
                                <PrintableReportFieldMeasurements generalInfoId={
                                    params.value
                                }/>
                            </div>
                        </Dialog>
